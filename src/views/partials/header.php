    ...
    <header>
        ...
        <div style="display: flex; flex-direction: row; gap: 25px;">
            ...
            <?php else: ?>
                ...
                <button class="button" style="padding: 15px;" data-action="notification"
                    onclick="document.getElementById('goNotif').submit()">
                    <span></span>
                    <svg height="70px" width="70px" fill="none" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
