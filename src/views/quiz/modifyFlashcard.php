...
<form style="display: flex; flex-direction: column; padding: 25px; gap: 20px" method = "post" data-id="<?php echo htmlspecialchars($idFlashcard) ?>" action = "index.php?page=flashcard&categorie=modify&id=<?php echo htmlspecialchars($idFlashcard) ?>">
    ...
    <div id = "parts" style="display: flex; flex-direction: column; gap: 20px">
        ...
        for($i = 0; $i < $taille ; $i = $i +1){
            ...
            echo '<div class="partContent question" style="grid-row-start: 1; grid-row-end: 2;">
