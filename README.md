...
```
cd existing_repo
git remote add origin https://forge.univ-lyon1.fr/p2401392/sae3.01.git
git branch -M main
...
- [ ] [Set up project integrations](https://forge.univ-lyon1.fr/p2401392/sae3.01/-/settings/integrations)
